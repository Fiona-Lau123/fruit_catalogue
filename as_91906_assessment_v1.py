...
def add_fruit():
    ...
    if fruit_check in fruits.keys():
        ...
        return add_fruit() # Goes back to add_fruit function
...
def sugar_value_check():
    ...
    # To check if the user entered anything. Calls empty_value function
...
def delete():
    ...
    # It would be looped going to verify function
