...
# def fruit_dictionary(added_fruit):
...
def fruit_details(fruit_name):
    ...
    if changes == "Change":
        ...
        msg = "Do you want to add another fruit?"
        title = "Adding another fruit"
        another_fruit = easygui.ynbox(msg, title)
